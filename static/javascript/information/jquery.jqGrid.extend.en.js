            ...
            beforeRequest: function(data) {
                ...
                case "script":
                    if (options.url == undefined || options.url == "") {
                        js.showMessage("settting error of the serchForm of null URL.");
                        return false
                    }
                }
                js.loading();
        ...
        if (options.btnSearch.length > 0) {
            options.btnSearch.unbind("click").click(function() {
                ...
                if (searchForm.hasClass("hide")) {
                    ...
                    btnSearch.html(btnSearch.html().replace("Search", "Hide").replace($.jgrid.extend.btnSearch, $.jgrid.extend.btnHideSearch))
                } else {
                    searchForm.addClass("hide");
                    btnSearch.removeClass("active");
                    btnSearch.html(btnSearch.html().replace("Hide", "Search").replace($.jgrid.extend.btnHideSearch, $.jgrid.extend.btnSearch))
                }
                resizeDataGrid();
                return false
            });
