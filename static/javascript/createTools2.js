function generateTools(id,variant,type,groupID,groupName,processName){
    var json = getConnections();
    var nodeVariant = "";
    var nodeNo = json[id+"nodeNo"];
    var param = {"function":variant,"nodeNo":nodeNo,"id":id,"type":type,"groupID":groupID,"groupName":groupName};
    $("#diagramContainer-main").css('width','83.33333333%');
	var propertyArea = $("#diagramContainer-control");
	propertyArea.css('display','block');
    propertyArea.empty();
    var html = '<div style="font-size:16px;text-align:center;color:#333 !important;padding-top:5px;padding-bottom:5px;"><span><i class="fa fa-gear"></i> Setting</span></div>'
    if (variant == "Start"){
        html = html + '<div id="property"><span style="margin-top:10px;">Node No</span>'
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            output = data['output'];
            name = data['name'];
            html = html + '<div id="property" style="height:100%;overflow:auto;overflow-x:hidden;"><span style="margin-top:10px;">Node No</span>'
                +'<input name="property" id="nodeNo" style="width:98%;">'
                +'<span style="margin-top:10px;">Last Node</span>'
                +'<input name="property" id="lastNode" style="width:98%">'
                +'<span style="margin-top:10px;">Next Node</span>'
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            html = html + '<div id="property" style="height:100%;overflow:auto;overflow-x:hidden;"><span style="margin-top:10px;">Node No</span>'
                ...
                +'<option value ="xlTop10Items" selected="selected">Top</option>'
                +'<option value ="xlBottom10Items">Bottom</option>'
                +'</select>'
