...
function(t) {
    ...
    d.prototype = {
        ...
        _process_options: function(e) {
            ...
            s.startDate !== -(1 / 0) && (s.startDate ? s.startDate instanceof Date ? s.startDate = this._local_to_utc(this._zero_time(s.startDate)) : s.startDate = v.parseDate(s.startDate, o, s.language, s.assumeNearbyYear) : s.startDate = -(1 / 0)),
            s.endDate !== 1 / 0 && (s.endDate ? s.endDate instanceof Date ? s.endDate = this._local_to_utc(this._zero_time(s.endDate)) : s.endDate = v.parseDate(s.endDate, o, s.language, s.assumeNearbyYear) : s.endDate = 1 / 0),
            ...
            s.daysOfWeekDisabled = t.map(s.daysOfWeekDisabled,
            function(t) {
            ...
            s.daysOfWeekHighlighted = t.map(s.daysOfWeekHighlighted,
            function(t) {
                return parseInt(t, 10);
            }),
            s.datesDisabled = s.datesDisabled || [],
            t.isArray(s.datesDisabled) || (s.datesDisabled = [s.datesDisabled]),
            s.datesDisabled = t.map(s.datesDisabled,
            function(t) {
                return v.parseDate(t, o, s.language, s.assumeNearbyYear);
            });
        ...
        _buildEvents: function() {
            ...
            this.isInput ? this._events = [[this.element, e]] : this.component && this.hasInput ? this._events = [[this.inputField, e], [this.component, {
        ...
        place: function() {
            ...
            "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (p -= e - u)) : d.left < 0 ? (this.picker.addClass("datepicker-orient-left"), p -= d.left - a) : p + e > n ? (this.picker.addClass("datepicker-orient-right"), p += u - e) : this.picker.addClass("datepicker-orient-left");
            var g, D = this.o.orientation.y;
            if ("auto" === D && (g = -o + f - i, D = 0 > g ? "bottom": "top"), this.picker.addClass("datepicker-orient-" + D), "top" === D ? f -= i + parseInt(this.picker.css("padding-top")) : f += c, this.o.rtl) {
                var v = n - (p + u);
                this.picker.css({
                    top: f,
                    right: v,
        ...
        fillDow: function() {
            ...
            function(t, e) {
                return parseInt(e) + 1;
            }), i += '<th class="cw">&#160;</th>'); e < this.o.weekStart + 7;) i += '<th class="dow',
        ...
        _fill_yearsView: function(i, a, s, n, o, r, h, l) {
            var d, c, u, p, f, g, D, v, y, m, w;
            for (d = "", c = this.picker.find(i), u = parseInt(o / s, 10) * s, f = parseInt(r / n, 10) * n, g = parseInt(h / n, 10) * n, p = t.map(this.dates,
            function(t) {
                return parseInt(t.getUTCFullYear() / n, 10) * n;
            }), c.find(".datepicker-switch").text(u + "-" + (u + 9 * n)), D = u - n, v = -1; 11 > v; v += 1) y = [a],
            m = null,
            -1 === v ? y.push("old") : 10 === v && y.push("new"),
            -1 !== t.inArray(D, p) && y.push("active"),
            (f > D || D > g) && y.push("disabled"),
            D === this.viewDate.getFullYear() && y.push("focused"),
            l !== t.noop && (w = l(new Date(D, 0, 1)), w === e ? w = {}: "boolean" == typeof w ? w = {
                enabled: w
            }: "string" == typeof w && (w = {
                classes: w
            }), w.enabled === !1 && y.push("disabled"), w.classes && (y = y.concat(w.classes.split(/\s+/))), w.tooltip && (m = w.tooltip)),
        ...
        fill: function() {
            ...
            u = D[this.o.language].today || D.en.today || "",
            p = D[this.o.language].clear || D.en.clear || "",
            f = D[this.o.language].titleFormat || D.en.titleFormat;
            if (!isNaN(o) && !isNaN(r)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(v.formatDate(n, f, this.o.language)),
                ...
                var m = new Date(g);
                g.getUTCFullYear() < 100 && m.setUTCFullYear(g.getUTCFullYear()),
                m.setUTCDate(m.getUTCDate() + 42),
                m = m.valueOf();
                for (var w, k = []; g.valueOf() < m;) {
                    ...
                    this.o.beforeShowDay !== t.noop && (s = this.o.beforeShowDay(this._utc_to_local(g)), s === e ? s = {}: "boolean" == typeof s ? s = {
                        ...
                        classes: s
                    }), s.enabled === !1 && w.push("disabled"), s.classes && (w = w.concat(s.classes.split(/\s+/))), s.tooltip && (a = s.tooltip)),
                    w = t.unique(w),
                    k.push('<td class="' + w.join(" ") + '"' + (a ? ' title="' + a + '"': "") + ">" + g.getUTCDate() + "</td>"),
                    a = null,
                    g.getUTCDay() === this.o.weekEnd && k.push("</tr>"),
    ...
    v = {
        ...
        parseDate: function(s, n, o, r) {
            ...
            if ("string" == typeof n && (n = v.parseFormat(n)), n.toValue) return n.toValue(s, n, o);
            var c, u, p, f, g = /([\-+]\d+)([dmwy])/,
            y = s.match(/([\-+]\d+)([dmwy])/g),
            m = {
                d: "moveDay",
                m: "moveMonth",
            ...
            if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s)) {
                for (s = new Date, p = 0; p < y.length; p++) c = g.exec(y[p]),
                u = parseInt(c[1]),
                f = m[c[2]],
                s = d.prototype[f](s, u);
                return i(s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate());
            }
            if ("undefined" != typeof w[s] && (s = w[s], y = s.match(/([\-+]\d+)([dmwy])/g), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s))) {
                for (s = new Date, p = 0; p < y.length; p++) c = g.exec(y[p]),
                u = parseInt(c[1]),
                f = m[c[2]],
                s = d.prototype[f](s, u);
            ...
            y = s && s.match(this.nonpunctuation) || [],
            s = new Date;
            var k, C, b = {},
            ...
            s = a();
            var M = n.parts.slice();
            if (y.length !== M.length && (M = t(M).filter(function(e, i) {
                return - 1 !== t.inArray(i, _);
            }).toArray()), y.length === M.length) {
                var U;
                for (p = 0, U = M.length; U > p; p++) {
                    if (k = parseInt(y[p], 10), c = M[p], isNaN(k)) switch (c) {
                    case "MM":
                        C = t(D[o].months).filter(l),
                        k = t.inArray(C[0], D[o].months) + 1;
                        break;
                    case "M":
                        C = t(D[o].monthsShort).filter(l),
                        k = t.inArray(C[0], D[o].monthsShort) + 1;
                    }
                    b[c] = k;
                }
                var F, x;
                for (p = 0; p < _.length; p++) x = _[p],
                x in b && !isNaN(b[x]) && (F = new Date(s), T[x](F, b[x]), isNaN(F) || (s = F));
            }
            return s;
        },
