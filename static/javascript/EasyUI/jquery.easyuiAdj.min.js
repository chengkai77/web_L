...
_33(e,"mousedown");
if($.fn.dragg_able.isDragging||$.fn.resiz_able.isResizing){
e.preventDefault();
}
};
function _34(e){
...
(function($){
function _39(e){
var _3a=$.data(e.data.target,"dragg_able");
var _3b=_3a.options;
var _3c=_3a.proxy;
var _3d=e.data;
...
function _3f(e){
var _40=$.data(e.data.target,"dragg_able");
var _41=_40.options;
var _42=_40.proxy;
if(!_42){
_42=$(e.data.target);
...
function _43(e){
if(!$.fn.dragg_able.isDragging){
return false;
}
var _44=$.data(e.data.target,"dragg_able");
var _45=_44.options;
...
var _4a=$.data(e.data.target,"dragg_able");
_39(e);
...
_49(e);
var _4f=$.data(e.data.target,"dragg_able");
var _50=_4f.proxy;
var _51=_4f.options;
...
function _4e(){
if($.fn.dragg_able.timer){
clearTimeout($.fn.dragg_able.timer);
$.fn.dragg_able.timer=undefined;
}
$(document).unbind(".dragg_able");
$.fn.dragg_able.isDragging=false;
setTimeout(function(){
$("body").css("cursor","");
},100);
};
$.fn.dragg_able=function(_57,_58){
if(typeof _57=="string"){
return $.fn.dragg_able.methods[_57](this,_58);
}
return this.each(function(){
var _59;
var _5a=$.data(this,"dragg_able");
if(_5a){
_5a.handle.unbind(".dragg_able");
_59=$.extend(_5a.options,_57);
}else{
_59=$.extend({},$.fn.dragg_able.defaults,$.fn.dragg_able.parseOptions(this),_57||{});
}
var _5b=_59.handle?(typeof _59.handle=="string"?$(_59.handle,this):_59.handle):$(this);
$.data(this,"dragg_able",{options:_59,handle:_5b});
if(_59.disabled){
$(this).css("cursor","");
return;
}
_5b.unbind(".dragg_able").bind("mousemove.dragg_able",{target:this},function(e){
if($.fn.dragg_able.isDragging){
return;
}
var _5c=$.data(e.data.target,"dragg_able").options;
if(_5d(e)){
$(this).css("cursor",_5c.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.dragg_able",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.dragg_able",{target:this},function(e){
if(_5d(e)==false){
return;
}
$(this).css("cursor","");
...
$.extend(e.data,_60);
var _61=$.data(e.data.target,"dragg_able").options;
if(_61.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.dragg_able",e.data,_43);
$(document).bind("mousemove.dragg_able",e.data,_49);
$(document).bind("mouseup.dragg_able",e.data,_4d);
$.fn.dragg_able.timer=setTimeout(function(){
$.fn.dragg_able.isDragging=true;
_43(e);
},_61.delay);
return false;
});
function _5d(e){
var _62=$.data(e.data.target,"dragg_able");
var _63=_62.handle;
var _64=$(_63).offset();
...
$.fn.dragg_able.methods={options:function(jq){
return $.data(jq[0],"dragg_able").options;
},proxy:function(jq){
return $.data(jq[0],"dragg_able").proxy;
},enable:function(jq){
return jq.each(function(){
$(this).dragg_able({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).dragg_able({disabled:true});
});
}};
$.fn.dragg_able.parseOptions=function(_67){
var t=$(_67);
return $.extend({},$.parser.parseOptions(_67,["cursor","handle","axis",{"revert":"boolean","deltaX":"number","deltaY":"number","edge":"number","delay":"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.dragg_able.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
...
(function($){
function _68(_69){
$(_69).addClass("dropp_able");
$(_69).bind("_dragenter",function(e,_6a){
$.data(_69,"dropp_able").options.onDragEnter.apply(_69,[e,_6a]);
});
$(_69).bind("_dragleave",function(e,_6b){
$.data(_69,"dropp_able").options.onDragLeave.apply(_69,[e,_6b]);
});
$(_69).bind("_dragover",function(e,_6c){
$.data(_69,"dropp_able").options.onDragOver.apply(_69,[e,_6c]);
});
$(_69).bind("_drop",function(e,_6d){
$.data(_69,"dropp_able").options.onDrop.apply(_69,[e,_6d]);
});
};
$.fn.dropp_able=function(_6e,_6f){
...
function _76(e){
var _77=e.data;
var _78=$.data(_77.target,"resiz_able").options;
...
function _7d(e){
$.fn.resiz_able.isResizing=true;
$.data(e.data.target,"resiz_able").options.onStartResize.call(e.data.target,e);
return false;
};
function _7e(e){
_76(e);
if($.data(e.data.target,"resiz_able").options.onResize.call(e.data.target,e)!=false){
_7b(e);
}
return false;
};
function _7f(e){
$.fn.resiz_able.isResizing=false;
_76(e,true);
_7b(e);
$.data(e.data.target,"resiz_able").options.onStopResize.call(e.data.target,e);
$(document).unbind(".resiz_able");
$("body").css("cursor","");
return false;
};
function _80(e){
var _81=$(e.data.target).resiz_able("options");
...
$.fn.resiz_able=function(_88,_89){
if(typeof _88=="string"){
return $.fn.resiz_able.methods[_88](this,_89);
}
return this.each(function(){
var _8a=null;
var _8b=$.data(this,"resiz_able");
if(_8b){
$(this).unbind(".resiz_able");
_8a=$.extend(_8b.options,_88||{});
}else{
_8a=$.extend({},$.fn.resiz_able.defaults,$.fn.resiz_able.parseOptions(this),_88||{});
$.data(this,"resiz_able",{options:_8a});
}
if(_8a.disabled==true){
return;
}
$(this).bind("mousemove.resiz_able",{target:this},function(e){
if($.fn.resiz_able.isResizing){
return;
}
var dir=_80(e);
$(e.data.target).css("cursor",dir?dir+"-resize":"");
}).bind("mouseleave.resiz_able",{target:this},function(e){
$(e.data.target).css("cursor","");
}).bind("mousedown.resiz_able",{target:this},function(e){
var dir=_80(e);
if(dir==""){
return;
}
...
$(document).bind("mousedown.resiz_able",_8d,_7d);
$(document).bind("mousemove.resiz_able",_8d,_7e);
$(document).bind("mouseup.resiz_able",_8d,_7f);
$("body").css("cursor",dir+"-resize");
});
});
};
$.fn.resiz_able.methods={options:function(jq){
return $.data(jq[0],"resiz_able").options;
},enable:function(jq){
return jq.each(function(){
$(this).resiz_able({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).resiz_able({disabled:true});
});
}};
$.fn.resiz_able.parseOptions=function(_8e){
var t=$(_8e);
return $.extend({},$.parser.parseOptions(_8e,["handles",{minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number",edge:"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.resiz_able.defaults={disabled:false,handles:"n, e, s, w, ne, se, sw, nw, all",minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000,edge:5,onStartResize:function(e){
},onResize:function(e){
...
_f2.disabledNodes=[];
_f3.dnd=true;
_f4.find("div.tree-node").dragg_able({disabled:false,revert:true,cursor:"pointer",proxy:function(_f5){
...
$(this).dragg_able("proxy").css({left:-10000,top:-10000});
...
var icon=$(_106).dragg_able("proxy").find("span.tree-dnd-icon");
...
if(item.iconCls!="null"&&item.iconCls!= ""&&typeof(item.iconCls)!="undefined"){
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"" + item.iconCls + ""+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
...
_2a1.window.dragg_able({handle:">div.panel-header>div.panel-title",disabled:_2a1.options.dragg_able==false,onBeforeDrag:function(e){
if(_2a1.mask){
...
_2a1.window.resiz_able({disabled:_2a1.options.resiz_able==false,onStartResize:function(e){
_2a2(e);
},onResize:function(e){
_2a3(e);
return false;
...
return $.extend({},$.fn.panel.parseOptions(_2af),$.parser.parseOptions(_2af,[{dragg_able:"boolean",resiz_able:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,dragg_able:true,resiz_able:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2b0(_2b1){
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resiz_able:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
function _2c5(){
...
function _2ca(_2cb){
var opts=$.extend({},$.messager.defaults,{modal:false,shadow:false,dragg_able:false,resiz_able:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},title:"",width:300,height:150,minHeight:0,showType:"slide",showSpeed:600,content:_2cb.msg,timeout:4000},_2cb);
...
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resiz_able:false,fn:function(){
}});
})(jQuery);
(function($){
...
_3d6.resiz_able($.extend({},{handles:(_3d5[dir]||""),disabled:(!pp.panel("options").split),onStartResize:function(e){
_3be=true;
...
var th=$(this);
var col=$.extend({},$.parser.parseOptions(this,["id","field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resiz_able:"boolean",fixed:"boolean"},{rowspan:"number",colspan:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
...
if(col.resiz_able==false){
cell.attr("resiz_able","false");
}
if(col.width){
...
_754.each(function(){
$(this).resiz_able({handles:_755,edge:opts.resizeEdge,disabled:($(this).attr("resiz_able")?$(this).attr("resiz_able")=="false":false),minWidth:25,onStartResize:function(e){
_750.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{groupHeight:28,expanderWidth:20,singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:20,resiz_able:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resiz_able:false}]],showGroup:false,groupView:_961,groupField:"group",groupStyler:function(_9b6,rows){
return "";
...
_cb6.find("a.slider-handle").dragg_able({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
