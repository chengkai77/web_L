(function(a) {
    ...
    var g = function(k, j) {
        ...
        this.icons = {
            leftArrow: this.fontAwesome ? "fa-arrow-left": (this.bootcssVer === 3 ? "fa-angle-double-left": "icon-arrow-left"),
            rightArrow: this.fontAwesome ? "fa-arrow-right": (this.bootcssVer === 3 ? "fa-angle-double-right": "icon-arrow-right")
        };
